...
public class Utils {
    ...
    public static void deletePDF(Context context, String forDelete) {
    ...
    public static void updatePDF(Context context, FragmentActivity fragmentActivity) {
        File internalDir = context.getDir(context.getString(R.string.ro_internal_pdf_folder), Context.MODE_PRIVATE);
        ...
        try {
            ...
            FTPFile[] subFiles = getDirectoryFiles(ftpClient, fragmentActivity.getString(R.string.ro_external_pdf_folder));
            ...
            Utils.downloadDirectory(ftpClient, fragmentActivity.getString(R.string.ro_external_pdf_folder), "", internalDir.getAbsolutePath());
    ...
    public static void updatePDF(Context context, FragmentActivity fragmentActivity, String file) {
        File internalDir = context.getDir(context.getString(R.string.ro_internal_pdf_folder), Context.MODE_PRIVATE);
        ...
        try {
            ...
            Utils.downloadDirectory(context, fragmentActivity, ftpClient, fragmentActivity.getString(R.string.ro_external_pdf_folder), "", internalDir.getAbsolutePath(), file);
